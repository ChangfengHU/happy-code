...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        archiveSession: '暂停会话',
        archiveSessionConfirm: '您确定要暂停此会话吗？',
        reactivateSession: '恢复会话',
        reactivateSessionChooseAction: '您想如何恢复此会话？',
        reactivateContinueOriginal: '继续原会话',
        reactivateFromTemplate: '从模板新建会话',
        reactivateContinueUnavailableTitle: '暂不支持继续原会话',
        reactivateContinueUnavailableMessage: '当前 agent 暂不支持继续原会话，将改为基于该会话模板新建。',
        ...
        archiveSessionSubtitle: '暂停此会话（不会删除）',
        metadata: '元数据',
        host: '主机',
        path: '路径',
