...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        archiveSession: 'Pause Session',
        archiveSessionConfirm: 'Are you sure you want to pause this session?',
        reactivateSession: 'Resume Session',
        reactivateSessionChooseAction: 'How would you like to resume this session?',
        reactivateContinueOriginal: 'Continue Original Session',
        reactivateFromTemplate: 'Start New Session from Template',
        reactivateContinueUnavailableTitle: 'Continue Unavailable',
        reactivateContinueUnavailableMessage: 'Continuing the original session is not available for this agent yet. We will start a new session from this template.',
        ...
        failedToArchiveSession: 'Failed to pause session',
        ...
        archiveSessionSubtitle: 'Pause this session without deleting it',
        metadata: 'Metadati',
        host: 'Host',
        path: 'Percorso',
