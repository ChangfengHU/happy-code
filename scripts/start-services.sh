...
show_help() {
  echo ""
  echo "Happy 开发环境启动脚本（不含 Daemon）"
  echo ""
  echo "用法: $0 [选项]"
  echo ""
  echo "选项:"
  echo "  all       启动所有服务 (Docker + Server + Expo) [默认]"
  echo "  docker    仅启动 Docker 服务 (PostgreSQL, Redis, MinIO)"
  echo "  apps      仅启动应用服务 (Server + Expo)"
...
main() {
  echo ""
  echo -e "${CYAN}╔═══════════════════════════════════════════╗${NC}"
  echo -e "${CYAN}║   Happy 开发环境启动（不含 Daemon）       ║${NC}"
  echo -e "${CYAN}╚═══════════════════════════════════════════╝${NC}"
